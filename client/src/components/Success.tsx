...
const Success = ({ message, onClose, duration = 4000, title = "Success" }: SuccessProps) => {
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3 bg-white border border-green-200 shadow-lg rounded-lg p-4 max-w-md">
