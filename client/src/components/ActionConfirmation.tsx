...
const ActionConfirmation = ({
    ...
    return (
        <div 
            className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4 transition-opacity duration-200 backdrop-blur-sm"
            onClick={onClose}
        >
            <div 
                className="bg-white rounded-2xl w-full max-w-md shadow-lg animate-fadeIn transition-all duration-300"
