...
const CourseLayout = () => {
  ...
  return (
    <MaterialsContext.Provider value={{ materials, setMaterials, materialsLoading, setShowNavigation}}>
      <div className="flex-1 min-h-0 bg-gradient-to-br from-surface-50 via-white to-surface-50 dark:from-surface-950 dark:via-surface-900 dark:to-surface-950 md:flex">
        {/* Sidebar Navigation */}
        {showNavigation && (
