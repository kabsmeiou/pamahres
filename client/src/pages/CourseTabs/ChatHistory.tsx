...
const ChatHistory = () => {
    ...
    const { data: history, isLoading, error } = useQuery<any>({
        queryKey: ['chatHistory', numericCourseId],
        queryFn: () => getHistory(numericCourseId) as Promise<any>,
    ...
    // Extract the messages from the previous_messages array
    const messages = history?.previous_messages || [];
