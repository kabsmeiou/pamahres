...
# tell django to use my user model in user/models.py
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        ...
        "auth.authentication.ClerkAuth",
    ),
    'DEFAULT_THROTTLE_CLASSES': [
        'rest_framework.throttling.AnonRateThrottle',
    ],
    'DEFAULT_THROTTLE_RATES': {
        'anon': '2/day', # Allows 2 requests per day for anonymous users
    },
...
CACHES = {
    "default": {
        ...
        "LOCATION": REDIS_URL,  # Redis DB 1 for caching
        "OPTIONS": {
