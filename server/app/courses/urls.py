...
urlpatterns = [
  ...
  path('<int:course_id>/materials/', CourseMaterialsView.as_view(), name='course-material-list-create'),
  path('<int:course_id>/materials/<int:material_id>/', CourseMaterialDetailView.as_view(), name='course-material-detail'),
  ...
  # quiz urls
  path('<int:course_id>/quizzes/', include('quiz.urls')),
]